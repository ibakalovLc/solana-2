...
"[project]/frontend/node_modules/@solana-mobile/mobile-wallet-adapter-protocol/lib/esm/index.browser.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createSIWSMessage(payload) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$util$2f$lib$2f$esm$2f$signIn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSignInMessageText"])(payload);
}
...
function fromUint8Array(byteArray) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$codecs$2d$strings$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBase58Decoder"])().decode(byteArray);
}
 ...
 */ function handleMobileWalletRequest(methodName, methodParams, protocolVersion) {
    ...
    let method = methodName.toString().replace(/[A-Z]/g, (letter)=>"_".concat(letter.toLowerCase())).toLowerCase();
    switch(methodName){
        case 'authorize':
            {
                let { chain } = params;
...
function getAssociateAndroidIntentURL(associationPublicKey, putativePort, associationURLBase) {
    let protocolVersions = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : [
        'v1'
    ];
    return __awaiter(this, void 0, void 0, function*() {
...
function getRemoteAssociateAndroidIntentURL(associationPublicKey, hostAuthority, reflectorId, associationURLBase) {
    let protocolVersions = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [
        'v1'
    ];
    return __awaiter(this, void 0, void 0, function*() {
        const exportedKey = yield crypto.subtle.exportKey('raw', associationPublicKey);
        ...
        url.searchParams.set('id', "".concat(fromUint8Array$1(reflectorId, true)));
        protocolVersions.forEach((version)=>{
            url.searchParams.set('v', version);
        });
        return url;
...
function transact(callback, config) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        const websocketURL = "ws://localhost:".concat(sessionPort, "/solana-wallet");
...
function startRemoteScenario(config) {
    return __awaiter(this, void 0, void 0, function*() {
        assertSecureContext();
        const associationKeypair = yield generateAssociationKeypair();
        const websocketURL = "wss://".concat(config === null || config === void 0 ? void 0 : config.remoteHostAuthority, "/reflect");
        let connectionStartTime;
        const getNextRetryDelayMs = (()=>{
            const schedule = [
                ...WEBSOCKET_CONNECTION_CONFIG.retryDelayScheduleMs
...
"[project]/frontend/node_modules/@solana-mobile/wallet-standard-mobile/lib/esm/index.browser.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class EmbeddedModal {
    ...
    constructor(){
        ...
        this.close = function() {
            let event = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : undefined;
            var _a;
            console.debug('Modal close');
            __classPrivateFieldGet$1(_this, _EmbeddedModal_instances, "m", _EmbeddedModal_removeEventListeners).call(_this);
            if (__classPrivateFieldGet$1(_this, _EmbeddedModal_root, "f")) {
                __classPrivateFieldGet$1(_this, _EmbeddedModal_root, "f").style.display = 'none';
            }
            (_a = __classPrivateFieldGet$1(_this, _EmbeddedModal_eventListeners, "f")['close']) === null || _a === void 0 ? void 0 : _a.forEach((listener)=>listener(event));
        };
...
class RemoteConnectionModal extends EmbeddedModal {
    ...
    populateQRCode(qrUrl) {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (qrcodeContainer) {
                const qrCodeElement = yield __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$qrcode$2f$lib$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].toCanvas(qrUrl, {
                    width: 200,
                    margin: 0
                });
...
const DEFAULT_FEATURES = [
    __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signAndSendTransaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignAndSendTransaction"],
    __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signTransaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignTransaction"],
    __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signMessage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignMessage"],
    __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signIn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignIn"]
];
class LocalSolanaMobileWalletAdapterWallet {
    ...
    get features() {
        return Object.assign({
            [__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$wallet$2d$standard$2f$features$2f$lib$2f$esm$2f$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardConnect"]]: {
                version: '1.0.0',
                connect: __classPrivateFieldGet$1(this, _LocalSolanaMobileWalletAdapterWallet_connect, "f")
            },
            [__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$wallet$2d$standard$2f$features$2f$lib$2f$esm$2f$disconnect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardDisconnect"]]: {
                version: '1.0.0',
                disconnect: __classPrivateFieldGet$1(this, _LocalSolanaMobileWalletAdapterWallet_disconnect, "f")
            },
            [__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$wallet$2d$standard$2f$features$2f$lib$2f$esm$2f$events$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardEvents"]]: {
                version: '1.0.0',
    ...
    constructor(config){
        ...
        _LocalSolanaMobileWalletAdapterWallet_connect.set(this, function() {
            let { silent } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        ...
        _LocalSolanaMobileWalletAdapterWallet_transact.set(this, (callback)=>__awaiter(this, void 0, void 0, function*() {
                ...
                try {
                    return yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$esm$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transact"])(callback, config);
                } catch (e) {
        ...
        _LocalSolanaMobileWalletAdapterWallet_accountsToWalletStandardAccounts.set(this, (accounts)=>{
            return accounts.map((account)=>{
                ...
                return {
                    address: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$bs58$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].encode(publicKey),
                    publicKey,
                    label: account.label,
                    icon: account.icon,
        ...
        _LocalSolanaMobileWalletAdapterWallet_signAndSendTransaction.set(this, function() {
        ...
        _LocalSolanaMobileWalletAdapterWallet_signTransaction.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
                return (yield __classPrivateFieldGet$1(this, _LocalSolanaMobileWalletAdapterWallet_performSignTransactions, "f").call(this, inputs.map((param)=>{
        ...
        _LocalSolanaMobileWalletAdapterWallet_signMessage.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
                const { authToken, chain } = __classPrivateFieldGet$1(this, _LocalSolanaMobileWalletAdapterWallet_assertIsAuthorized, "f").call(this);
                const addresses = inputs.map((param)=>{
                    let { account } = param;
                    return fromUint8Array(account.publicKey);
                });
                const messages = inputs.map((param)=>{
                    let { message } = param;
                    return fromUint8Array(message);
                });
                try {
                    return yield __classPrivateFieldGet$1(this, _LocalSolanaMobileWalletAdapterWallet_transact, "f").call(this, (wallet)=>__awaiter(this, void 0, void 0, function*() {
                            yield __classPrivateFieldGet$1(this, _LocalSolanaMobileWalletAdapterWallet_performReauthorization, "f").call(this, wallet, authToken, chain);
        ...
        _LocalSolanaMobileWalletAdapterWallet_signIn.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    return {
                        account: Object.assign(Object.assign({}, signedInAccount !== null && signedInAccount !== void 0 ? signedInAccount : {
                            address: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$bs58$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].encode(toUint8Array(signedInAddress))
                        }), {
...
class RemoteSolanaMobileWalletAdapterWallet {
    ...
    constructor(config){
        ...
        _RemoteSolanaMobileWalletAdapterWallet_connect.set(this, function() {
            let { silent } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return __awaiter(_this, void 0, void 0, function*() {
        ...
        _RemoteSolanaMobileWalletAdapterWallet_transact.set(this, (callback)=>__awaiter(this, void 0, void 0, function*() {
                ...
                try {
                    const { associationUrl, close, wallet } = yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$esm$2f$index$2e$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startRemoteScenario"])(remoteConfig);
        ...
        _RemoteSolanaMobileWalletAdapterWallet_signAndSendTransaction.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
        ...
        _RemoteSolanaMobileWalletAdapterWallet_signTransaction.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
                return (yield __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_performSignTransactions, "f").call(this, inputs.map((param)=>{
                    let { transaction } = param;
                    return transaction;
                }))).map((signedTransaction)=>{
                    return {
        ...
        _RemoteSolanaMobileWalletAdapterWallet_signMessage.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
        ...
        _RemoteSolanaMobileWalletAdapterWallet_signIn.set(this, function() {
            for(var _len = arguments.length, inputs = new Array(_len), _key = 0; _key < _len; _key++){
                inputs[_key] = arguments[_key];
            }
            return __awaiter(_this, void 0, void 0, function*() {
...
class ErrorModal extends EmbeddedModal {
    ...
    populateError(error) {
        ...
        if (errorMessageElement) {
            ...
            errorMessageElement.innerHTML = "An unexpected error occurred: ".concat(error.message);
        } else {
                        ...
                        const parsedAccounts = parsed.accounts.map((account)=>{
                            return Object.assign(Object.assign({}, account), {
                                publicKey: 'publicKey' in account ? new Uint8Array(Object.values(account.publicKey)) // Rebuild publicKey for WalletAccount
                                 : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$bs58$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].decode(account.address)
                            });
                        });
    ...
    return {
        select (chains) {
            return __awaiter(this, void 0, void 0, function*() {
                if (chains.length === 1) {
                    return chains[0];
                } else if (chains.includes(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$chains$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SOLANA_MAINNET_CHAIN"])) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$chains$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SOLANA_MAINNET_CHAIN"];
...
//# sourceMappingURL=9e883_%40solana-mobile_952e7c40._.js.map