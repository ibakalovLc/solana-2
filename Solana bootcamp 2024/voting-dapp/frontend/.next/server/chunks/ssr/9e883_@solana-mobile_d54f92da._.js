...
class RemoteConnectionModal extends EmbeddedModal {
    ...
    populateQRCode(qrUrl) {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (qrcodeContainer) {
                const qrCodeElement = yield __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].toCanvas(qrUrl, {
                    width: 200,
                    margin: 0
                });
...
class LocalSolanaMobileWalletAdapterWallet {
    constructor(config){
        ...
        _LocalSolanaMobileWalletAdapterWallet_transact.set(this, (callback)=>__awaiter(this, void 0, void 0, function*() {
                ...
                try {
                    return yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["transact"])(callback, config);
                } catch (e) {
        ...
        _LocalSolanaMobileWalletAdapterWallet_accountsToWalletStandardAccounts.set(this, (accounts)=>{
            return accounts.map((account)=>{
                ...
                return {
                    address: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$bs58$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(publicKey),
                    publicKey,
                    label: account.label,
                    icon: account.icon,
                ...
                try {
                    ...
                    return {
                        account: Object.assign(Object.assign({}, signedInAccount !== null && signedInAccount !== void 0 ? signedInAccount : {
                            address: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$bs58$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].encode(toUint8Array(signedInAddress))
                        }), {
...
class RemoteSolanaMobileWalletAdapterWallet {
    constructor(config){
        ...
        _RemoteSolanaMobileWalletAdapterWallet_transact.set(this, (callback)=>__awaiter(this, void 0, void 0, function*() {
                ...
                try {
                    const { associationUrl, close, wallet } = yield (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$solana$2d$mobile$2f$mobile$2d$wallet$2d$adapter$2d$protocol$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startRemoteScenario"])(remoteConfig);
...
function getIsLocalAssociationSupported() {
    return "undefined" !== 'undefined' && window.isSecureContext && typeof document !== 'undefined' && /android/i.test(navigator.userAgent);
}
function getIsRemoteAssociationSupported() {
    return "undefined" !== 'undefined' && window.isSecureContext && typeof document !== 'undefined' && !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
}
                        ...
                        const parsedAccounts = parsed.accounts.map((account)=>{
                            return Object.assign(Object.assign({}, account), {
                                publicKey: 'publicKey' in account ? new Uint8Array(Object.values(account.publicKey)) // Rebuild publicKey for WalletAccount
                                 : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$bs58$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].decode(account.address)
                            });
                        });
...
//# sourceMappingURL=9e883_%40solana-mobile_d54f92da._.js.map